...
> [!tip]- Tip
> If you want to add an image from inside your vault, you can also [embed an image in a note](https://obsidian.md/help/embeds#Embed%20an%20image%20in%20a%20note).
...
> [!tip]- Tip
> You can turn your quote into a [callout](https://obsidian.md/help/callouts) by adding `[!info]` as the first line in a quote.
...
Use the [Footnotes view](https://obsidian.md/help/plugins/footnotes) to see all footnotes in a note.
