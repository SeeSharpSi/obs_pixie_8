...
source: https://www.ibm.com/think/topics/bias-variance-tradeoff
author:
- '[[Fangfang Lee]]'
...
In [machine learning (ML)](https://www.ibm.com/think/topics/machine-learning) and [artificial intelligence (AI)](https://www.ibm.com/think/topics/artificial-intelligence), bias-variance tradeoff is a concept that governs the performance of a [predictive machine learning model](https://www.ibm.com/think/topics/machine-learning-algorithms) and a fundamental tenant in [data science](https://www.ibm.com/think/topics/data-science).
...
![Bias variance diagram](https://assets.ibm.com/is/image/ibm/bias-variance-diagram?ts=1763386342614&dpr=off)
...
![Graphic of noisy data](https://assets.ibm.com/is/image/ibm/noisy-data?ts=1763386343027&dpr=off)
...
![Polynomial degree 1](https://assets.ibm.com/is/image/ibm/polynomial_degree_1?ts=1763386343318&dpr=off)
...
![Polynomial degree 4](https://assets.ibm.com/is/image/ibm/polynomial_degree_4?ts=1763386343668&dpr=off)

Now we use a polynomial that includes powers of x up to $x^4$ :

$$ \hat{y} = \beta_0+\beta_1x+\beta_2 x^2+\beta_3 x^3+\beta_4 x^4 $$
...
$$ \hat{y}=\sum_{i=0}^{25}\beta_i x^i $$

![Polynomial degree 25](https://assets.ibm.com/is/image/ibm/polynomial_degree_25?ts=1763386344047&dpr=off)
...
![Bias variance tradeoff](https://assets.ibm.com/is/image/ibm/bias_variance_tradeoff_padding?ts=1763386344599&dpr=off)
