...
Related games: [Kierki](https://www.pagat.com/compendium/kierki.html), [Trix](https://www.pagat.com/compendium/trex.html), [King](https://www.pagat.com/compendium/king.html), [Canadian Salad](https://www.pagat.com/compendium/canadian_salad.html), [Lora (Serbian, Croatian)](https://www.pagat.com/compendium/lora.html), [Lórum (Hungarian)](https://www.pagat.com/compendium/lora.html#lorum)

[Browse classification network](https://www.pagat.com/class/network.php?gid=151&nbhood=2)

[⭐⭐⭐⭐Difficulty](https://www.pagat.com/statistics/#symbols)
...
](https://www.pagat.com/statistics/#symbols)
...
Andy Christensen has provided a [preprinted score sheet](https://www.pagat.com/docs/Barbu%204-player%20scoresheet%202018.pdf).
...
Here is a [description of Barbu \[zipped MSWord file\]](https://www.pagat.com/docs/barbuRules.zip) contributed by David Smith of Cambridge, MA, USA - it has slightly different scoring from the description on this page, and includes further material on strategy.
...
Noel Leaver, Don Lagosz-Sinclair, Mark Brader and David Smith have contributed [versions of Barbu for three players](https://www.pagat.com/invented/barbu3.html).

### Barbette

Warren Chang has developed [Barbette](https://www.pagat.com/invented/barbette.html), a shortened version of Barbu that takes only 16 deals rather than 28 or 32.

### Buckhaven High School version

Barbu is often played in France with only 32 cards. The version formerly played at Buckhaven High School, Fife, Scotland is a development of this form, with several additional features. Scott Geissler ([scottgeissler@tiscali.co.uk](mailto:scottgeissler@tiscali.co.uk)) has contributed his rule book for [Buckhaven High School Barbu](https://www.pagat.com/docs/Barbu2006.doc) in the form of a Microsoft Word Document.

## Other Barbu Web Pages

The late Jeff Goldsmith's [San Francisco Barbu](https://www.jeff-goldsmith.com/games/sfbarbu.html) page includes a number of variations and alternative scoring schedules. He also published a [strategy guide](https://www.jeff-goldsmith.com/games/barbu.txt).

Here are Ethan Bradford's [Yale Barbu](https://sites.google.com/site/yalebarbu/) rules and a [scoring spreadsheet](https://docs.google.com/spreadsheets/d/1p2dCc8-2oAEcghgVDrTPTF2wb6ex8bStWXw2k2r3WgY/edit#gid=4) for this variant, which automatically calculates scores from input of the game, doubles and number of penalty cards etc. taken.

Here is an archive copy of Tom Carmichael's [Barbu Page](https://web.archive.org/web/19981205040350/http://www.fragment.com/~tomc/barbu.html) which gave rules in English.

Jean-François Bustarret had a [Barbu page](https://web.archive.org/web/20250207230830/https://www.jeuxdecartes.net/jeux-cartes/Barbu/) (archive copy) with rules in French. The game is for 3 to 5 players and the scoring and set of contracts is somewhat different. The points are negative and the scores are:
...
Shireen Mohandes and Andy Bowles run an [Online Barbu](http://www.barbu.co.uk/) page with rules, bidding competitions, online games and tournaments and a ladder.

You can play Barbu online against computer or human opponents at [CardzMania.com](https://www.cardzmania.com/Barbu).

[Home Page](https://www.pagat.com/) > [Classified Index](https://www.pagat.com/class/) > [Compendium Games](https://www.pagat.com/compendium/) > Barbu