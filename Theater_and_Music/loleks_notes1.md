...
## 1st
* Walk upstage behind table, end up on right side of Tommy (scene where he puts shawl on Amy)
* Bring object that has some sort of meaning to you

## 03-10

### tech week
* Sign-in sheet on the way down to dressing rooms
* schedule next to sign-in sheet
* 30-min for dinner
* no notes after show; always before next show
* always leave costume at theater
* we sign-in for the shows as well
...
* Last scene (Kyle dies) come from in front of (stage right) Exit running away from gun down stage right stairs pg. 76
...
* work on New York / Boston accent
* don't touch curtains
* tomorrow's focus:
	* Do physicality: the movement and intention behind what we're saying. Throw it out to the audience more
Open a
Soft t th
Soft r
...
* 1st scene (goons)
	...
	* Exit: front house
	* pg. 8
* 2nd scene (handsome man)
	* Enter: front house
	* Exit: front house
	* pg. 10
* 3rd scene (goons, Kyle buys shawl)
	* Enter: behind barn
	* Exit: behind house
	* pg. 34
* 4th scene (hoe down)
	...
	* Exit: behind barn
	* pg. 51
* 5th scene (goons, snooping)
	* Enter: behind barn
	* Exit: behind barn
	* pg. 65
* 6th scene (Kyle Dies)
	* Enter: front house
	* Exit: stage right stairs
	* pg. 76

## 3-12
* We've got lights today!
* stage right handsome man jacket and hat, for hoedown as well

### notes
* Let Mama finish the whole line "I know my rights. . ." to approach
* tomorrow's focus:
...
### notes
* Dani liked it 
* Be far out on hoedown during stomp-clap section, though don't be so far the house is annoying 
* Wear white button up 
* Bow on bar after Kyle, then all bow on next bar
...
### notes
* Be swimming-er
* Late entrance was mom's fault
* don't take other people's notes
* mics are hot..?
* No hat for fight scene 
* Hoedown scoot, to make room for ppl going around you 
* call time is 6pm

## 3-15
* Check curtain for fight scene entrance, it's different 
* 

## 3-16
* Stop talking whilst off stage 
